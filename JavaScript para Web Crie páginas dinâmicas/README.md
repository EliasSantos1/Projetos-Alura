...
O Alura MIDI é um instrumento musical de interface digitial (MIDI), que reproduz sons de instrumentos musicais, por enquanto de uma bateria, ao usuário clicar ou pressionar com teclado em seus botões. Este projeto foi criado durante o curso de **JavaScript para web: crie páginas dinâmicas** da plataforma Alura.
...
Busque na plataforma da Alura o curso [JavaScript para web: crie páginas dinâmicas](https://cursos.alura.com.br/course/javascript-web-paginas-dinamicas) publicado na Escola Frontend.
